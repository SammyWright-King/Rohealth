            ...
            <div class="main-content-container">
                ...
                <div class="card-container">
                    <div class="card-content">
                        <div class="card flex">
                            <img src="{{ asset('app_assets/images/health_plans.svg')}}" alt="health_plans">
                            <div class="ml-15">
                                <h6 class="card-heading">12</h6>
                                <p class="card-paragraph mt-2">Total Health Plans</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-content">
                        <div class="card flex">
                            <img src="{{ asset('app_assets/images/wallet_balance.svg')}}" alt="wallet_balance">
                            <div class="ml-15">
                                <h6 class="card-heading"><span>&#x20A6;</span> 45,000</h6>
                                <p class="card-paragraph mt-2">Wallet Balance</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-content">
                        <div class="card flex">
                            <img src="{{ asset('app_assets/images/total_employees.svg')}}" alt="total_employes">
                            <div class="ml-15">
                                <h6 class="card-heading">100</h6>
                                <p class="card-paragraph mt-2">Total Employees</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-container">
                    <div class="card-content2">
                        <div class="card">
                            <h6 class="card-heading2">Account Officer’s Details</h6>
                            <div class="flex-center mt-20">
                                <div class="mobile_big_circle">
                                    <div class="mobile_small_circle">
                                        <h6>OL</h6>
                                    </div>
                                </div>
                                <div class="ml-15">
                                    <p class="account-heading">Olalekan Olude</p>
                                    <p class="account-paragraph">qabagq@rohealth.com</p>
                                    <p class="account-paragraph">0810 315 3845</p>
                                </div>
                            </div>
                        </div>
                        <div class="card card-mt">
                            <div class="flex-center flex-between">
                                <h6 class="card-heading2">Wallet</h6>
                                <a href="#" class="fund-wallet">
                                    <img src="{{ asset('app_assets/images/wallet.svg')}}" alt="wallet-icon">
                                    <p class="ml-10">Fund Wallet</p>
                                </a>
                             </div>
                            <div class="wallet-card mt-30 mb-50">
                                <img src="{{ asset('app_assets/images/wallet-card.svg')}}">
                                <div class="wallet-card-details">
                                    <p>Total Balance</p>
                                    <h3><span>₦</span> 4,500.00</h3>
                                </div>
                            </div>
                            <a href="#" class="link">View Wallet History</a>
                        </div>
                    </div>
                    <div class="card-content2">
                        <div class="card">
                            <div class="flex-center flex-between">
                                <h6 class="card-heading2">Employees</h6>
                                <a href="#" class="card-link card-span flex-center">View All <img src="assets/images/arrow-right.svg" alt="arrow-right" class="ml-10"></a>
                            </div>
                            <div class="employees-list mt-20">
                                <div class="employee-div">
                                    <div class="flex-center">
                                        <div class="mobile_big_square">
                                            <div class="mobile_small_square">
                                                <h6>OL</h6>
                                            </div>
                                        </div>
                                        <p class="ml-10">Lekan Olude</p>
                                    </div>
                                    <div class="employee-package">
                                        <p class="text-orange">Bronze Package</p>

                ...
                <div class="mt-20 tabs effect">
                    ...
                    <div class="tab-content">
                        <section id="tab-item-1">
                            <div class="flex flex-center flex-between mt-20">
                                <h3>Company Roles</h3>
                                <button class="button_blue">Add New Admin</button>
                            </div>
                            <div class="card-container mt-30">
                                <div class="card horizontal-scroll">
                                    <table class="employee-table">
                                        ...
                                        <tr>
                                            <td><p>Olalekan Olude</p></td>
                                            <td><span>olalekanolude@gmail.com</span></td>
                                            <td><span>21/01/2020</span></td>
                                            <td><span class="color-blue">Primary Admin</span></td>
                                ...
                                <div class="card">
                                   <h4>Personal Details</h4>
                                    <div class="personal-details-heading">
                                        ...
                                        <div class="flex">
                                            <button class="button_blue">Upload New Photo</button>
                                            <button class="button_outline_blue ml-15">Remove Photo</button>
                                        </div>
                                    </div>

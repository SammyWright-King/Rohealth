            ...
            <div class="main-content-container">
                ...
                <div class="card-container">
                    <div class="card-content2">
                        <div class="card">
                            <p class="card-paragraph">Total Balance</p>
                            <h2 class="mt-10">NGN 4,500.00</h2>
                            <hr class="mt-20 mb-20">
                            <div class="fund-div">
                                <input placeholder="Enter Amount">
                                <button class="button_blue">Fund Wallet</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-content2">
                        <div class="flex-center flex-between">
                            <div class="card w-50">
                                <p class="payment-heading color-blue">12</p>
                                <h6 class="payment-paragraph color-blue">All Transactions</h6>
                            </div>
                            <div class="card w-50">
                                <p class="payment-heading color-green">12</p>
                                <h6 class="payment-paragraph color-green">Successful Transactions</h6>
                            </div>
                        </div>
                        <div class="flex-center flex-between">
                            <div class="card w-50">
                                <p class="payment-heading color-yellow">12</p>
                                <h6 class="payment-paragraph color-yellow">Pending Transactions</h6>
                            </div>
                            <div class="card w-50">
                                <p class="payment-heading color-red">12</p>
                                <h6 class="payment-paragraph color-red">Red Transactions</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card horizontal-scroll">
                        <table class="employee-table">
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('assets/images/more.svg')}}" alt="more"></td>
                            </tr>
                            <tr>
                                <td><p>Wallet Fund</p></td>
                                <td><span>02/20/2021</span></td>
                ...
                <div class="flex-center flex-between mt-30">
                    <div class="flex">
                        ...
                        <h6 class="table-heading ml-15 color-black flex-center">10 <img src="{{ asset('app_assets/images/drop-down.svg')}}" class="ml-5"></h6>
                    </div>
                    <div class="flex">
